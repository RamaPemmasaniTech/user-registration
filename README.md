...
- **Job Name:** `dev-deploy`
- **Folder Name:** `user-registration`

#### 2. **Git Configuration**
- **GitHub URL:** `https://github.com/techworldwithmurali/user-registration.git`
- **Branch:** `helm-deploy-on-eks-jfrog-jenkinsfile`
...
stage('Clone') {
            steps {
                git branch: 'helm-deploy-on-eks-jfrog-jenkinsfile', credentialsId: 'github-cred', url: 'https://github.com/techworldwithmurali/helmchart.git'
            }
        }
```
...
stage('Clone') {
            steps {
                git branch: 'helm-deploy-on-eks-jfrog-jenkinsfile', credentialsId: 'github-cred', url: 'https://github.com/techworldwithmurali/ingress.git'
            }
        }
```
...
### **Congratulations!**
You have successfully deployed the application on Kubernetes using a Helm chart, with the Docker image fetched from Jfrog using Jenkins Pipeline job..
