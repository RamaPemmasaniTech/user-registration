...
```bash
git clone https://github.com/techworldwithmurali/user-registration.git -b helm-deploy-on-eks-dockerhub
...
1. **Clone the Ingress Helm Chart**:  
   ...
   ```bash
   git clone https://github.com/techworldwithmurali/ingress.git -b helm-deploy-on-eks-dockerhub
   cd ingress
   ```
