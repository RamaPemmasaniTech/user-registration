...
- **Branch:** `helm-deploy-on-eks-ecr-jenkinsfile`
...
stage('Clone the repository') {
            steps {
                git branch: 'helm-deploy-on-eks-ecr-jenkinsfile', credentialsId: 'github-cred', url: 'https://github.com/techworldwithmurali/ingress.git'
            }
        }
```
